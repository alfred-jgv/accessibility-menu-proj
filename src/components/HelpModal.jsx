...
function HelpModal({ show, handleClose }) {
  const helpItems = [
    ...
    {
      icon: <FaVolumeUp />,
      text: "Enable Read Aloud: Click to have the website read text aloud for you. Ensure your volume is up.",
    },
    {
      icon: <FaSearchPlus />,
      text: "Increase Font Size: Click to make the text larger for easier reading.",
    },
    {
      icon: <FaSearchMinus />,
      text: "Decrease Font Size: Click to make the text smaller if it's too big.",
    },
    {
      icon: <FaAdjust />,
      text: "Toggle Contrast: Simplifies the website design to highlight important information.",
    },
    {
      icon: <FaSearch />,
      text: "Magnify: Zooms in to view text and images in greater detail.",
    },
  ];
